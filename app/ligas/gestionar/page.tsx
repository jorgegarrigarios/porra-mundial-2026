...
export default function GestionarLigasPage() {
    ...
    <main className="ligasPage">
      <div className="ligasContainer">
        <div className="ligasHeader">
          ...
          <div>
            <p className="eyebrow">Gestión de ligas</p>
            <h1>Tus ligas privadas</h1>
            <p>
              {tieneLigasActivas
                ? "Cambia de liga, únete a otra o solicita una nueva."
